  ...
  <footer class="footer">
    <div class="footer__inner">
      <div class="footer__nav">
          ...
          <div class="footer__nav-column-social">
            <h4>SOCIAL</h4>
            <div class="footer__logo">
              <svg width="283" height="21" viewBox="0 0 283 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M64.2912 17.7432H66.7411L73.4226 0.222709H76.2437L82.9252 17.7432H85.2267V19.7476H77.9512V17.7432H80.4754L78.9163 13.7343H70.6015L69.0425 17.7432H71.7151V19.7476H64.3654V17.7432H64.2912ZM71.1954 11.7298H78.2482L74.7589 2.52413L71.1954 11.7298Z" fill="white"/>
            ...
            <div class="footer__nav-column-social-links">
              <a href="https://www.facebook.com/Black-Mile-1858736260877076/" rel="noreferrer" title="Facebook" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
              </a>
              <a href="https://instagram.com/blackmiletravel/" rel="noreferrer" title="Instagram" target="_blank">
...
<style lang="scss">
  ...
  .footer {
    ...
    &__nav {
      display: grid;
      grid-template-columns: minmax(min-content, 200px) 1fr auto;
